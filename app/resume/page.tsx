...
export default function ResumePage() {
  return (
    <main className="resume-page">
      <nav className="resume-nav"><a href="/">← Portfolio</a><ResumeLink /></nav>
      <header className="resume-header"><div><span>Lead Product Designer</span><h1>Aamir Khan</h1></div><p>12+ years designing thoughtful digital products, platforms and experiences across AI, SaaS, marketplaces, mobility and service platforms.</p></header>
