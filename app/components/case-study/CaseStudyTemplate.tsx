...
function Visual({ visual, className = "" }: { visual: CaseStudyVisual; className?: string }) {
  return (
    <figure className={`cs-visual ${className}`.trim()}>
      ...
      <article>
        ...
        <nav className="cs-story-nav" aria-label="Case study sections">
          <div className="cs-shell">
            {["Overview", "Problem", "Discovery", "Decisions", "Validation", "Solution", "Outcome"].map(item => <a key={item} href={`#${item.toLowerCase()}`}>{item}</a>)}
          </div>
        </nav>
        ...
        <section className="cs-problem" id="problem">
          <div className="cs-shell">
            <div className="cs-section-heading reveal"><span>02 · The problem</span><h2>The reminder had to carry more than a time.</h2><p>{project.problem.intro}</p></div>
        ...
        <section className="cs-section cs-shell" id="discovery">
          <div className="cs-section-heading reveal"><span>03 · Research & discovery</span><h2>Understand the routine before designing the reminder.</h2><p>{project.research.intro}</p></div>
        ...
        <section className="cs-insights">
          <div className="cs-shell">
            <div className="cs-section-heading reveal"><span>04 · Key insights</span><h2>Three ideas shaped the experience.</h2></div>
        ...
        <section className="cs-section cs-shell cs-strategy">
          <div className="cs-section-heading reveal"><span>05 · Defining the experience</span><h2>{project.strategy.heading}</h2><p>{project.strategy.description}</p></div>
        ...
        <section className="cs-section cs-shell cs-exploration">
          <div className="cs-sticky-copy reveal"><span>06 · Exploration</span><h2>{project.exploration.heading}</h2><p>{project.exploration.description}</p><ul>{project.exploration.notes.map(note => <li key={note}>{note}</li>)}</ul></div>
          <Visual visual={project.exploration.visual} />
        </section>

        <section className="cs-section cs-shell" id="decisions">
          <div className="cs-section-heading reveal"><span>07 · Key design decisions</span><h2>Decisions connected directly to the product problem.</h2></div>
        ...
        <section className="cs-system">
          <div className="cs-shell">
            <div className="cs-section-heading reveal"><span>08 · Design system / UI</span><h2>{project.designSystem.heading}</h2><p>{project.designSystem.description}</p></div>
        ...
        <section className="cs-section cs-shell" id="validation">
          <div className="cs-section-heading reveal"><span>09 · Validation</span><h2>Make the evidence visible—and the gaps honest.</h2><p>{project.validation.intro}</p></div>
        ...
        <section className="cs-final" id="solution">
          <div className="cs-shell">
            <div className="cs-section-heading reveal"><span>10 · Final solution</span><h2>{project.finalSolution.heading}</h2><p>{project.finalSolution.intro}</p></div>
        ...
        <section className="cs-section cs-shell" id="outcome">
          <div className="cs-section-heading reveal"><span>11 · Outcome / impact</span><h2>What changed—and what still needs measuring.</h2></div>
        ...
        <section className="cs-learning">
          <div className="cs-shell reveal"><span>12 · What I learned</span><blockquote>{project.learning}</blockquote></div>
        </section>
